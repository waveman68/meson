...
class CoreData:
    ...
    def _set_others_from_buildtype(self, value: str) -> bool:
        ...
        dirty |= self.optstore.set_option(options.OptionParts('optimization'), opt)
        dirty |= self.optstore.set_option(options.OptionParts('debug'), debug)
...
#                                 fatal=False)
    ...
    def set_options(self, opts_to_set: T.Dict[OptionKey, T.Any], subproject: str = '', first_invocation: bool = False) -> bool:
        ...
        if pfk in opts_to_set:
            ...
            dirty |= self.optstore.set_option(options.OptionParts('prefix'), prefix)
